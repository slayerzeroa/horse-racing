...
regressor = XGBRegressor(n_estimators=1000, random_state=0, max_depth=4, learning_rate=0.01, min_child_weight=5, gamma=0.1, subsample=0.8, colsample_bytree=0.8, reg_alpha=0.005)
